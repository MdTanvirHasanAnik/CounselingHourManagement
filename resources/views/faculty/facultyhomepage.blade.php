                    ...
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                ...
                                <li><a title="Professor Profile" href="{{ route('profile.faculty') }}"><span class="mini-sub-pro">Professor Profile</span></a></li>
                            </ul>
                        </li>
                        <li>
                    ...
                    @if(!($data->isEmpty()))
                        ...
                        <table class="table table-striped">
                            ...
                            <tr>
                                ...
                                <button type="button"  onclick="deleteCounseling('{{$d->id}}')" class="btn btn-danger" data-toggle="modal" data-target="#myModal">Delete</button>
...
<div id="myModal" class="modal fade">
	<div class="modal-dialog modal-confirm">
		<div class="modal-content">
            ...
            <form action="{{route('counseling.delete')}}" method="get">
